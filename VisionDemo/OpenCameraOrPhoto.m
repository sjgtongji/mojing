...
- (void)takePhoto
{
    ...
    {
        UIAlertController *actionSheet = [UIAlertController alertControllerWithTitle:@"提示" message:@"请开启”相机服务“，开启方法为“手机设置-隐私-相机服务”进行[开启]" preferredStyle:UIAlertControllerStyleActionSheet];
...
- (void)showOpenCameraOrPhotoWithView:(UIView *)view withBlock:(OpenCameraOrPhotoBlock)openCameraOrPhotoBlock
{
    ...
    self.actionSheet.popoverPresentationController.sourceRect = CGRectMake(view.frame.size.width/2,view.frame.size.height,2.0,2.0);
