...
/**
 ...
 @return 返回
 */
+ (UIImage *)gl_drawImage:(UIImage *)image faceLandMarkPoints:(NSArray *)landMarkPoints color:(UIColor *)cl;
...
+ (UIImage *)gl_drawImage2:(UIImage *)image faceLandMarkPoints:(NSArray *)landMarkPoints;
/**
 旋转图片保存正立
